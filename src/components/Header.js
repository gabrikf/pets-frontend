            ...
            <div className="relative flex items-center justify-between h-16">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                ...
                <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                  ...
                  {open ? (
                    <AiOutlineFullscreenExit className="block h-6 w-6" aria-hidden="true" />
                  ) : (
                    <AiOutlineMenu className="block h-6 w-6 dark:text-white" aria-hidden="true" />
                  )}
                </Disclosure.Button>
              </div>
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                  <FaPaw className='text-gray-900 dark:text-white' size={30}/>
                </div>
                    ...
                    {navigation.map((item) => (
                      ...
                      onClick={() => setCurrentValue(item.name)}
                        ...
                        className={classNames(
                          item.name === current ? 'bg-gray-600 dark:bg-gray-900 text-white' : 'text-gray-800 dark:text-white hover:bg-gray-700 hover:text-white',
